...
class MCMC_by_bp():
    def __init__(self, model, optimizer, temperature, sigma=1.0, sigma_adam_dir = None, **kwargs):
        '''
        class implementing the AdamCMCM algorithm. 
        Can be used similar to torchch.optimizer.Optimizer instances, but loss needs to be defined for fixed newtork weights when .step is called.
